...
# This function (Main_Menu) is not an external code. However, the method of user inputting numbers to navigate (using if-else statements) was inspired by this source https://www.youtube.com/watchv=0m7csmqWAgI&t=8s&ab_channel=GeekTutorials I felt it was important to cite this. 
def Main_Menu():
    """ 
